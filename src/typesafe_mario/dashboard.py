...
class LiveDashboard:
    ...
    def draw(
        ...
        *,
        ...
        action_name = (
            "Reading state…" if decision is None else (decision.skill_name or decision.action.value).replace("_", " ")
        )
        ...
        metrics = (
            ("Confidence", "N/A" if confidence is None else f"{confidence * 100:.0f}%"),
